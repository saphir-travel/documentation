 ...
 *         <ul>
 *             <li>
 *                 <a href="#heading_without_child"/>
 *             </li>
 *             <li>
 *                 <a href="#heading_with_children">text</a>
 *                 <ul>...</ul>
 *             </li>
 *         </ul>
 *     </li>
 ...
 *        <ul>
 *            <li>
 *                <a href="#heading_without_child">text</a>
 *            </li>
 *            <li>
 *                <a href="#heading_with_children" class="o_toc_entry_wrapper">
...
const _prepareAccordion = (tocElement) => {
    ...
    tocRoot.querySelectorAll('ul').forEach(tocEntryList => {
        ...
        relatedHeadingRef.classList.add('o_toc_entry_wrapper');
        ...
        // Create a <span> element with the text of the <a>.
        const span = document.createElement('SPAN');
        span.innerText = relatedHeadingRef.innerText
        relatedHeadingRef.innerText = null;
        // Insert the <i> and <span> elements inside the <a>.
        relatedHeadingRef.append(arrowButton, span);
    });
};
